...
export const _JPP = [...Array(4)].map((_, index) => {
  ...
  const status = ["In service", "Stand By", "Shutdown"][index];
  const tankStatus = ["Service", "Setlling", "Feding","Filling","Return","Maintenance"][index]
...
export const _locations = {
  ...
  name: {
    ...
    fts_1: ["SKID#1 SP#1","SKID#1 SP#2","SKID#1 SP#3","SKID#1 SP#4","SKID#1 SP#5"],
